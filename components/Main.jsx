      ...
      <div className="max-w-[1240px] w-full h-full mx-auto px-2 sm:px-4 md:px-8 flex justify-center items-center">
        <div>
          ...
          <p className="py-4 text-gray-600 max-w-[70%] m-auto">
            ...
            en alternance chez <a className="text-[#5651e5] underline" href="https://passedevant.net/?utm_source=googlemb&utm_medium=gmb&utm_campaign=gmb">Passedevant</a> pour développer mes compétences sur le terrain.
          </p>
